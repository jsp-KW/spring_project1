	...
	<div class="container">
		...
		<h3>공공도서관 주소 분포</h3>
			...
			<p style="margin-top:-12px">
			    사용한 데이터를 보시려면 
			    <em class="link">
			       <a href="/library_api_default3.do" target="_blank">여기를 클릭하세요!</a>
			    </em>
			</p>
			<div id="map" style="width:100%;height:500px;"></div>
			
			<!-- jQuery 별도 로드가 필요합니다! -->
			<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=71a383ea400e6eab6628c65e3e238e5f&libraries=clusterer"></script>
			<script>
