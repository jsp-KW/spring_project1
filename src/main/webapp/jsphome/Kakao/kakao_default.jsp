<%@page import="kr.co.megait.dao.VisitDAO"%>
...
<body>
	...
	<div class="container">
		...
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=71a383ea400e6eab6628c65e3e238e5f"></script>
		...
		<%} else {%>
			...
			var iwContentTemp = contentsTemp, iwRemoveable = true;
