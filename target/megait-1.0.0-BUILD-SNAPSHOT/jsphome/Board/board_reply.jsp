...
<body>
    ...
    <table style="width: 700px;">
        <tr>
            ...
            <td style="width:80%">
                <input type="text" style="width:350px;max-width: 350px;" name="board_title" id="board_title" value="<%=board_title%>">
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="text" style="width:200px;max-width: 150px;" value="<%=member_id%>" disabled>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
                <input type="text" style="width:200px;max-width: 150px;" value="<%=member_name%>" disabled>
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="width:80%">
            	...
            	<textarea name="board_contents" id="board_contents" style="width:100%;height:300px;display:none;">
            		<%=board_contents %>
            	</textarea>
...
<script>
	...
	function send_modify(){
		...
		obj.action="/web_project2/BoardReplyServlet";
		obj.submit();
	}
